...
Window.clearcolor = (0.5, 0.75, 0, 0.75)
btn_color = "#003153"
...
class InstrScr(Screen):
    def __init__(self, **kwargs):
        ...
        instr = ScrollLabel(txt_instruction, textcolor = '#003153')
...
class PulseScr(Screen):
    def __init__(self, **kwargs):
        ...
        instr = ScrollLabel(txt_test1, textcolor = '#003153')
        lbl1 = ScrollLabel('Считайте пульс', textcolor = '#003153')
        self.lbl_sec = Seconds(15, textcolor = '#003153')
        self.lbl_sec.bind(done=self.sec_finished)

        line1 = ColoredLayout(lcolor = (.165, .38, .10))
        vlay = ColoredLayout(lcolor = (.41, .49, .51))
...
class CheckSits(Screen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.next_screen = False
        instr = ScrollLabel(txt_sits, size_hint=(0.3, 1), textcolor = '#003153')
        lbl1 = ScrollLabel('Сделайте 30 приседаний', textcolor = '#003153')
        line = ColoredLayout(lcolor = (.165, .38, .10))
...
class PulseScr2(Screen):
    def __init__(self, **kwargs):
        ...
        self.next_screen = False
        self.stage = 0
        instr = ScrollLabel(txt_test3, textcolor = '#003153')
        self.lbl1 = ScrollLabel('Считайте пульс', textcolor = '#003153')
        self.lbl_sec = Seconds(15, textcolor = '#003153')
        self.lbl_sec.bind(done=self.sec_finished)

        line0 = ColoredLayout(lcolor = (.165, .38, .10))
        vlay = ColoredLayout(lcolor = (.41, .49, .51))
...
class Result(Screen):
    def __init__(self, **kwargs):
        ...
        self.instr = ScrollLabel('', textcolor = '#003153')
